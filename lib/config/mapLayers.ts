...
export const mapTileLayers: TileLayers = {
  ...
  watersheds: {
    ...
    url: "https://api.mapbox.com/styles/v1/intlrivers/clm3q7poc00u001pe70spejuj/tiles/512/{z}/{x}/{y}?access_token=pk.eyJ1IjoiaW50bHJpdmVycyIsImEiOiJjbG0waDcxNzkxZHJrM2RzNnRxaW1uZW5rIn0.KDQxxL5W3vYqN3c5Hzbnzg",
  ...
  rivers: {
    name: "rivers",
    displayName: "Rivers",
    url: "https://api.mapbox.com/styles/v1/intlrivers/clm4thx3700uj01pj8fjahweu/tiles/512/{z}/{x}/{y}?access_token=pk.eyJ1IjoiaW50bHJpdmVycyIsImEiOiJjbG0waDcxNzkxZHJrM2RzNnRxaW1uZW5rIn0.KDQxxL5W3vYqN3c5Hzbnzg",
    attribution: "Data from HydroSHEDS",
    information: "Data from HydroSHEDS",
    toggleable: true,
  },
